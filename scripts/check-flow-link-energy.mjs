...
const checks = [
  ...
  [eng.includes('LINK_ENERGY_DASH_PERIOD = 100'), 'dash period 100 (3 blips on pathLength 300)'],
  [eng.includes('LINK_ENERGY_PATH_LENGTH = 300') && eng.includes('applyLinkEnergyPathMetrics'), 'pathLength 300 for fixed 3 energy'],
  [css.includes('stroke-dasharray:8 92') && css.includes('stroke-dasharray:5 95'), 'thin 3-period dasharray'],
  [css.includes('stroke-width:1.7') && css.includes('stroke-width:4.2'), 'thinner energy strokes'],
