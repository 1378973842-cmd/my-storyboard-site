...
const checks = [
  ...
  [eng.includes('imageEditOriginBadgeHtml(node)'), 'badge rendered on image node'],
  [eng.includes('${originBadge}<div class="image-preview-wrap"'), 'badge above preview wrap (not overlay)'],
